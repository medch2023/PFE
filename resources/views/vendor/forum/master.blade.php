...
<body>
    <nav class="v-navbar navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url(config('forum.web.router.prefix')) }}"><img src="{{ asset ('logo/1.png') }}" width="100px">
</a>
            ...
            <div class="collapse navbar-collapse" :class="{ show: !isCollapsed }">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="/forum/recent">Discussions récentes</a>
                    </li>
                    @auth
                        <li class="nav-item">
                            <!--<a class="nav-link" href="{{ route('forum.unread') }}">{{ trans('forum::threads.unread_updated') }}</a>-->
                            <a class="nav-link" href="/forum/unread">Discussions non lues et mises à jour</a>
                        </li>
                    @endauth
                    @can ('moveCategories')
                        <li class="nav-item">
                            <!--<a class="nav-link" href="{{ route('forum.category.manage') }}">{{ trans('forum::general.manage') }}</a>-->
                            <a class="nav-link" href="/forum/manage">Gérer</a>
                        </li>
                    @endcan
                </ul>
                <ul class="navbar-nav">
